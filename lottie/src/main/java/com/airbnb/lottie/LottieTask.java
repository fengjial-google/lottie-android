...
public class LottieTask<T> {
  ...
  // Handler to notify listener on UI thread. If view is rendered on per-window UI thread, app should override {@link Context#getMainLooper()} for the
  // {@link WindowContext} that hosts the view tree so that uiHandler will point to the per-window ui thread.
